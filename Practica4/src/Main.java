...
public class Main {
    public static void main(String[] args) {} {
        ...
        Area a1 = new Area ("Urgencias",7,6, h1); // Todavia no se suman los medicos porque no hay medicos creados para agregarlos al area
        Area a2 = new Area("Radiografia", 3, 5, h1);
